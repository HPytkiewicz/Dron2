...
DronPodwodny: obj/Dr3D_gnuplot_api.o obj/main.o obj/Wektor.o obj/Macierz.o obj/Dron.o obj/Plaszczyzna.o
	g++ -o DronPodwodny obj/main.o obj/Dr3D_gnuplot_api.o obj/Wektor.o obj/Macierz.o obj/Dron.o obj/Plaszczyzna.o -lpthread
